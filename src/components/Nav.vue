<template>
  <v-navigation-drawer permanent absolute dark color="primary">
    <v-img max-height="120" max-width="150" src="../assets/logo.svg"></v-img>
    ...
    <v-btn color="secondary" depressed elevation="2">Sair</v-btn>
  </v-navigation-drawer>
</template>
  ...
  data() {
    return {
      items: [
        ...
        { title: "Configurações", icon: "mdi-application-settings" },
